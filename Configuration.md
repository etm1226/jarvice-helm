...
```egl```|Use GPU-based 3D server-side rendering via EGL to accelerate 3D OpenGL applications|See [Release Notes](ReleaseNotes.md) for the most up to date information on this feature as well as operational guidance.
